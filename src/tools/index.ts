...
// Register all tools on the MCP server. lspClient/rootDir are read through getters (rather
// than captured as plain values) because registration happens once at startup, before
// start_lsp has created the LSPClient or the caller has picked a root directory — each
// handler must see whatever the current value is at call time, not at registration time.
export const registerTools = (
  ...
  mcpServer.registerTool(
    "get_info_on_location",
    {
      ...
      inputSchema: GetInfoOnLocationArgsSchema
    },
    async (args) => {
  ...
  mcpServer.registerTool(
    "get_completions",
    {
      ...
      inputSchema: GetCompletionsArgsSchema
    },
    async (args) => {
  ...
  mcpServer.registerTool(
    "get_code_actions",
    {
      ...
      inputSchema: GetCodeActionsArgsSchema
    },
    async (args) => {
  ...
  mcpServer.registerTool(
    "restart_lsp_server",
    {
      ...
      inputSchema: RestartLSPServerArgsSchema
    },
    async (args) => {
      const lspClient = getLspClient();
      checkLspClientInitialized(lspClient);

      const restartRootDir = args.root_dir || getRootDir();
  ...
  mcpServer.registerTool(
    "start_lsp",
    {
      ...
      inputSchema: StartLSPArgsSchema
    },
    async (args) => {
      const startRootDir = args.root_dir || getRootDir();
  ...
  mcpServer.registerTool(
    "open_document",
    {
      ...
      inputSchema: OpenDocumentArgsSchema
    },
    async (args) => {
  ...
  mcpServer.registerTool(
    "close_document",
    {
      ...
      inputSchema: CloseDocumentArgsSchema
    },
    async (args) => {
  ...
  mcpServer.registerTool(
    "get_diagnostics",
    {
      ...
      inputSchema: GetDiagnosticsArgsSchema
    },
    async (args) => {
      const lspClient = getLspClient();
      checkLspClientInitialized(lspClient);
  ...
  mcpServer.registerTool(
    "set_log_level",
    {
      ...
      inputSchema: SetLogLevelArgsSchema
    },
    async (args) => {
      const { level } = args;
      setLogLevel(level);
